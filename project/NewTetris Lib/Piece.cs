...
namespace NewTetris_Lib
{
    ...
    public class Piece
    {
        ...
        /// <summary>
        /// Array of all the Piece instances, used to clear pictureBoxes from rows.
        /// </summary>
        public static List<Piece> fieldPieces = new List<Piece>();
        ...
        public Piece(Position pos, bool dest)
        {
            this.pos = pos;
            pic = new PictureBox();
            ...
            } else { Game.next.Controls.Add(pic); }
            
            UpdateImgPos();
            fieldPieces.Add(this);
        }
        ...
        /// <summary>
        /// Called during the CheckClearAllRows method, clears the
        /// PictureBoxes from the rows and drops the picture boxes of all
        /// PictureBoxes above the row being delted down a single row.
        /// </summary>
        /// <param name="r"> r is the row being deleted </param>
        public static void RemoveRowImg(int r)
        {
            // Check the position of every piece to see 
            foreach (Piece piece in fieldPieces)
            {

                if (piece.pos.y / SIZE == r)
                {
